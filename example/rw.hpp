...
#ifndef __INTERFACE_____EXAMPLE_RW_I
#define __INTERFACE_____EXAMPLE_RW_I
//test include
#include <tuple>
//test namespace
namespace example{
...
class Reader {
 private:
  ...
  struct __VirtualTable {
    ...
    inline static __VirtualTable virtualTable{&__T::read,};
  };
 public:
  struct Dummy{};
 private:
  ...
  Proxy<Dummy> object;
 public:
  Reader(void* vtb, Proxy<Dummy>&& obj) : virtualTable(reinterpret_cast<__VirtualTable<Dummy>*>(vtb)), object(std::move(obj)) {}
  template<typename __U, typename E = std::enable_if_t<!is_shared_ptr_v<__U> && !is_unique_ptr_v<__U>>>Reader(__U* u) : virtualTable(reinterpret_cast<__VirtualTable<Dummy>*>(&__VirtualTable<__U>::virtualTable)), object(reinterpret_cast<Dummy*>(u)) {}
  template<typename __U, typename E = std::enable_if_t<!is_shared_ptr_v<__U> && !is_unique_ptr_v<__U>>>Reader(__U& u) : virtualTable(reinterpret_cast<__VirtualTable<Dummy>*>(&__VirtualTable<__U>::virtualTable)), object(reinterpret_cast<Dummy*>(&u)) {}
  template<typename __U, typename E = std::enable_if_t<!is_shared_ptr_v<__U> && !is_unique_ptr_v<__U> && !std::is_lvalue_reference_v<__U>>>Reader(__U&& u) : virtualTable(reinterpret_cast<__VirtualTable<Dummy>*>(&__VirtualTable<__U>::virtualTable)), object(std::forward<__U>(u)) {}
  template<typename __U>Reader(const std::shared_ptr<__U>& u) : virtualTable(reinterpret_cast<__VirtualTable<Dummy>*>(&__VirtualTable<__U>::virtualTable)), object(u) {}
  template<typename __U>Reader(std::shared_ptr<__U>&& u) : virtualTable(reinterpret_cast<__VirtualTable<Dummy>*>(&__VirtualTable<__U>::virtualTable)), object(std::move(u)) {}
  template<typename __U>Reader(const std::unique_ptr<__U>& u) : virtualTable(reinterpret_cast<__VirtualTable<Dummy>*>(&__VirtualTable<__U>::virtualTable)), object(u) {}
  template<typename __U>Reader(std::unique_ptr<__U>&& u) : virtualTable(reinterpret_cast<__VirtualTable<Dummy>*>(&__VirtualTable<__U>::virtualTable)), object(std::move(u)) {}
...
class Writer {
 private:
  ...
  struct __VirtualTable {
    ...
    inline static __VirtualTable virtualTable{&__T::write,};
  };
 public:
  struct Dummy{};
 private:
  ...
  Proxy<Dummy> object;
 public:
  Writer(void* vtb, Proxy<Dummy>&& obj) : virtualTable(reinterpret_cast<__VirtualTable<Dummy>*>(vtb)), object(std::move(obj)) {}
  template<typename __U, typename E = std::enable_if_t<!is_shared_ptr_v<__U> && !is_unique_ptr_v<__U>>>Writer(__U* u) : virtualTable(reinterpret_cast<__VirtualTable<Dummy>*>(&__VirtualTable<__U>::virtualTable)), object(reinterpret_cast<Dummy*>(u)) {}
  template<typename __U, typename E = std::enable_if_t<!is_shared_ptr_v<__U> && !is_unique_ptr_v<__U>>>Writer(__U& u) : virtualTable(reinterpret_cast<__VirtualTable<Dummy>*>(&__VirtualTable<__U>::virtualTable)), object(reinterpret_cast<Dummy*>(&u)) {}
  template<typename __U, typename E = std::enable_if_t<!is_shared_ptr_v<__U> && !is_unique_ptr_v<__U> && !std::is_lvalue_reference_v<__U>>>Writer(__U&& u) : virtualTable(reinterpret_cast<__VirtualTable<Dummy>*>(&__VirtualTable<__U>::virtualTable)), object(std::forward<__U>(u)) {}
  template<typename __U>Writer(const std::shared_ptr<__U>& u) : virtualTable(reinterpret_cast<__VirtualTable<Dummy>*>(&__VirtualTable<__U>::virtualTable)), object(u) {}
  template<typename __U>Writer(std::shared_ptr<__U>&& u) : virtualTable(reinterpret_cast<__VirtualTable<Dummy>*>(&__VirtualTable<__U>::virtualTable)), object(std::move(u)) {}
  template<typename __U>Writer(const std::unique_ptr<__U>& u) : virtualTable(reinterpret_cast<__VirtualTable<Dummy>*>(&__VirtualTable<__U>::virtualTable)), object(u) {}
  template<typename __U>Writer(std::unique_ptr<__U>&& u) : virtualTable(reinterpret_cast<__VirtualTable<Dummy>*>(&__VirtualTable<__U>::virtualTable)), object(std::move(u)) {}
